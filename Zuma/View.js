...
export default class View{
  ...
  addButtonTo(visualBall) {
    ...
    button.addEventListener("click", () => {
      ...
      // Notify controller that we want to insert a new ball here
  ...
  animateFromCanonBallToFinalPosition( visualBall ) {
    ...
    function doneMoving() {
      ...
      // Notify controller when ball has moved
  ...
  animateBallToDisappear( visualBall ) {
    ...
    function doneDisappearing() {
      ...
      // Notify controller when ball is gone
      this.controller.displayBalls(this.controller.model);
      this.controller.checkMoreMatches();
    }
  }
}
